...
module.exports = function (grunt) {
  ...
  var jsFilesToInject = [
    ...
    'linker/js/jquery-1.9.1.js',
    'linker/js/handlebars.js',
    'linker/js/ember-1.0.0-rc.7.js',
  ...
  grunt.initConfig({
    ...
    ember_handlebars: {
      options: {
        processName: function(filename) {
          return filename.replace('assets/linker/templates/', '').replace('.html', '');
        }
      },
      compile: {
        files: {
          '.tmp/public/hbs.js': templateFilesToInject
        }
      }
    },
    ...
    'sails-linker': {
      ...
      // Bring in Handlebars template object
      devTpl: {
        options: {
          startTag: '<!--TEMPLATES-->',
        ...
        files: {
          '.tmp/public/index.html': ['.tmp/public/hbs.js'],
          'views/**/*.html': ['.tmp/public/hbs.js'],
          'views/**/*.ejs': ['.tmp/public/hbs.js']
        }
      },
